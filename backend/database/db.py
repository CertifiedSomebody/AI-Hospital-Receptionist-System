"""
AI Hospital Receptionist System - Database Core
...
# ----------------------------
# Init DB (call once at startup)
# ----------------------------
def init_db():
    import backend.models  # auto-register models
