"""
AI Hospital Receptionist System - Main Flask App (Enhanced)
...
def create_app():
    ...
    # ----------------------------
    # Register Blueprint (IMPORTANT FIX)
    # ----------------------------
...
if __name__ == "__main__":
    logger.info("🚀 Starting AI Hospital Receptionist System...")
    ...
    # ----------------------------
    if check_ollama():
        logger.info("✅ Ollama AI service detected")
    else:
        logger.warning("⚠️ Ollama not running (AI will fallback)")
